...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('courses/' .$courses->id) }}" method="post">
        ...
        <input type="text" name="syllabus" id="address" value="{{$courses->syllabus}}" class="form-control"></br>
        <label>Duration</label></br>
        <input type="text" name="duration" id="mobile" value="{{$courses->duration}}" class="form-control"></br>
